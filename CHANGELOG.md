...
## [0.3.0-alpha.3] - 2026-08-10

### Changed

- Updated the LeviLamina build and package dependency to `26.10.14` for the target production server running BDS `1.26.10.4` (protocol `944`)
- Added `scripts/bump_version.py` to validate and update the `tooth.json` version source
- Changed the commit-message build triggers to `build-release` and `build-action`
